...
__description__ = 'Produce vectors from list fof words for nlgclu input'
...
class Vectors(defaultdict):
	...
	@classmethod
	def fromFile(cls, lines=None, char_feature=True, token_feature=False, token_delimiter=" "):
		vectors = cls()
		if lines != None:
	...
	def _build_vector(self, lines, char_feature=True, token_feature=False, morph_feature=False, lemma_feature=False, token_delimiter=" ", ):
